...
#' @param na.missing If TRUE, missing is considered as NA. If FALSE, the missing is considered as 0. Default is FALSE.
#' @param smoothing If TRUE, the curve is smoothed first and evaluated at every interval minutes. Default is TRUE. If na.missing is TRUE, smoothing is automatically FALSE.
#'
#' @importFrom hms hms
...
data.grid = function(data, variable, interval = 3, na.missing = FALSE, smoothing = TRUE)
{
